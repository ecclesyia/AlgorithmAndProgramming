...
Follow this guide to set up the **GCC (MinGW)** compiler and configure VS Code correctly on Windows.
...
1.  Open any `.c` file in VS Code (e.g. `1.Introducing to Algorithm and Programming/HelloWorld!.c`).
